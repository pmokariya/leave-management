...
class AbsencesControllerTest < ActionController::TestCase
  ...
  test "should create absence" do
    assert_difference('Absence.count') do
      post :create, absence: { from_date: @absence.from_date, reason: @absence.reason, to_date: @absence.to_date }
    end
  ...
  test "should update absence" do
    patch :update, id: @absence, absence: { from_date: @absence.from_date, reason: @absence.reason, to_date: @absence.to_date }
    assert_redirected_to absence_path(assigns(:absence))
  end
